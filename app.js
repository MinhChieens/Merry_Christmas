...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Merry Christmas <3";
    let charArrTitle = textTitle.split('');
let text = "Chúc cậu giáng sinh vui vẻ .Năm mới sẽ mang đến cho bạn nhiều thành công, sức khỏe tốt và những trải nghiệm đáng nhớ =)). Thanks you so much <3__________Thân!"
